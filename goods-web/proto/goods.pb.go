...
type GoodsFilterRequest struct {
	...
	Brand       int32  `protobuf:"varint,10,opt,name=brands,proto3" json:"brands,omitempty"`
}
...
type GoodsInfoResponse struct {
	...
	Brand           *BrandInfoResponse         `protobuf:"bytes,22,opt,name=brands,proto3" json:"brands,omitempty"`
}
...
var file_goods_proto_depIdxs = []int32{
	...
	15, // 3: CategoryBrandResponse.brands:type_name -> BrandInfoResponse
